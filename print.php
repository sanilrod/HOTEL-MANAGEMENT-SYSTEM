...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SUN RISE HOTEL,</p>
				<p>Gass,<br>Kandok No 1,<br>Vasai[w].</p>
				<p>+91 9730547746</p>
			</address>
			<span><img alt="" src="images/sun.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@sunrise.com || Web :- www.sunrise.com || Phone :- +91 9730547746 </p>
				<br><br>
				<div class="row">
				<center><button class='btn btn-primary' onclick="myFunction()"><i class='fa fa-print' ></i> Print</button>
				<a href="https://paytm.com/" class='btn btn-success'><i class='fa fa-money' ></i> Pay</a></center>
				</div>
		</aside>
		<script>
function myFunction() {
