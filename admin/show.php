	...
	?>
		...
		<article>
			...
			<address >
				...
				<p><br></p>
				<p>Coustomer Name  : -  <?php echo $name;?><br></p>
			</address>
			<table class="meta">
				<tr>
			...
			<table >
					<tr> 
						<td>Customer phone : -  <?php echo $ph_no; ?> </td>
						
						<td>Customer email : -  <?php echo $email; ?> </td>
					</tr>
					<tr> 
						<td>Customer Country : -  <?php echo $pass; ?> </td>
						<td>Customer National : -  <?php echo $nation; ?> </td>
					</tr>
				</table>
				<br>
				<br>
