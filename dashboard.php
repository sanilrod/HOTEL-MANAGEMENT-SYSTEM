        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a  href="reservation.php"><i class="fa fa-bar-chart-o"></i> Room Booking</a>
                    </li>
                    ...
                    <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-success" type="button">
												 Room Status<span class="badge"></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
									...
									<?php
									$sql = "SELECT * FROM user WHERE uname = '".$_SESSION['user']."'";
                      ...
                      <!-- End  Basic Table  --> 
								...
								<div class="panel panel-success">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTo"  class="collapsed">
											<button class="btn btn-danger" type="button">
												 Available Rooms<span class="badge"></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    <div id="collapseTo" class="panel-collapse collapse" style="height: auto;">
                                        <div class="panel-body">
                                           <div class="panel panel-default">
                                <div class="panel-body">
                            <div class="table-responsive">
